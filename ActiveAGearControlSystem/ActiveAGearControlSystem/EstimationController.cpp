...
namespace ActiveAGearControlSystem
{
	...
	double * EstimationController::GetEstimatedAngle(double * anglesamples, double * bicepssamples, double * tricepssamples, double * previous_angle, double * previous_biceps_emg, double * previous_triceps_emg, double * previous_estimated_angle)
	{
		...
		//Convert EMG digital value to millivolts 
		for (int i = 0; i < filtersize; i++)
		{
			bicepssamples[i] = (double)(((bicepssamples[i] * 3) / 4095) - 1.5) / 1.008;
			tricepssamples[i] = (double)(((tricepssamples[i] * 3) / 4095) - 1.5) / 1.008;
		}
