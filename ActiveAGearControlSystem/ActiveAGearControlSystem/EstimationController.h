...
namespace ActiveAGearControlSystem
{
	...
	public:
		...
		~EstimationController();
		double * GetEstimatedAngle(double * anglesamples, double * bicepssamples, double * tricepssamples, double * prevangle, double * prevbemg, double * prevtemg, double * prevestimatedang);
